...
namespace project_1
{
    public partial class Form6 : Form
    {
        ...
        public Form6(bool exi, Form2 f2)
        {
            InitializeComponent();
            exist_ = exi;
            for2 = f2;
        ...
        public Form6(bool exi, Form2 f2, string _id, string[] v)
        ...
        private void button6_Click(object sender, EventArgs e) // Save
        {
            if (exist_ == false) // Create
            {
                try
                {
                    ...
                    _getCommand("INSERT INTO alinacursach.customers VALUES(" + textBox1.Text + ", '" + textBox2.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "')").ExecuteScalar();
                    connection.Close();
                ...
                {
                    connection.Open();
                    _getCommand("update alinacursach.customers set p_name = '" + textBox2.Text + "', p_surname = '" + textBox3.Text + "', p_patron = '" + textBox4.Text + "' Where ID_custom = " + Convert.ToInt32(textBox1.Text)).ExecuteScalar();
                    connection.Close();
                    for2._updateDataGrid();
                    this.Close();
